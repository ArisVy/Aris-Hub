...
_G.Config={
    ...
    -- Hitbox
    Hitbox_P=false, HitboxSize=150, Hitbox_WallCheck=false, Hitbox_TeamCheck=true, Hitbox_Box=false,
    -- Misc
...
RunService.Heartbeat:Connect(function()
    ...
    if _G.Config.Hitbox_P and _G.Config.LowHP_KS and myRoot then
        for _, p in Players:GetPlayers() do
            ...
            if _G.Config.Hitbox_TeamCheck and p.Team == LocalPlayer.Team then continue end
    ...
    for _,p in Players:GetPlayers()do
        ...
        -- ESP & Chams Logic (Giữ nguyên như cũ)
        ...
        if _G.Config.ESP_Name_P or _G.Config.ESP_Health_P or _G.Config.ESP_Distance_P or _G.Config.ESP_Box_P then
            if not ESP_Store[p.Name] then
                -- Tạo BillboardGui (Code cũ của bạn)
