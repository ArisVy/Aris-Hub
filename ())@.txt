...
game:GetService("StarterGui"):SetCore("SendNotification",{
    ...
    Text="Nạp thành công! Đã nâng cấp 3D Hitbox & Sắp xếp UI.",
    Duration=8
})
...
-- HÀM MỚI: LẤY MÀU GRADIENT (XANH-ĐEN-ĐỎ-ĐEN-HỒNG) CHO VIỀN HITBOX 3D THEO THỜI GIAN
...
-- CHUYỂN WALKSPEED XUỐNG DƯỚI TEAM CHECK
...
-- [FIX FREEZE]: KHÔNG ÉP SIZE SAU KHI TẮT
...
-- VÒNG LẶP WALKSPEED (Chạy cực mạnh)
RunService.RenderStepped:Connect(function()
