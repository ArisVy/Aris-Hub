...
--===============================================================
-- FAST RESPAWN (NOVA LÓGICA SIMPLIFICADA)
--===============================================================
...
--===============================================================
-- RESPAWN & LOGICA ANTIGA (MANTIDA PARA O MODO FIX)
--===============================================================
...
--===============================================================
-- EVENTO DE RESPAWN GLOBAL (ATUALIZA O MARKER)
--===============================================================
player.CharacterAdded:Connect(function(char)
	local hrp = char:WaitForChild("HumanoidRootPart", 10)
	if not hrp then return end
    
    -- Pequeno delay para garantir que o Fast Respawn consiga te colocar 
    -- no lugar da morte antes do marker atualizar pra posição final.
    task.wait(0.1)
...
-- GUI
--===============================================================
if CoreGui:FindFirstChild("ArisDesyncGUI") then CoreGui.ArisDesyncGUI:Destroy() end
if CoreGui:FindFirstChild("ArisMinimizeButton") then CoreGui.ArisMinimizeButton:Destroy() end

local gui = Instance.new("ScreenGui")
gui.Name = "ArisDesyncGUI"
...
updateBtn.MouseButton1Click:Connect(function()
    if not desyncState then
        StarterGui:SetCore("SendNotification", {
            Title = "ARIS DESYNC",
            Text = "Ative o botão Desync Primeiro",
...
creditsLabel.Text = "Feito pelo Vini.xits 🇧🇷"
