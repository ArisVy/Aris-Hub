...
_G.Config={
    ...
    Hitbox_Box=false,
    ESP_2D_Hitbox=false, -- [NEW] Bật tắt tính năng ESP 2D Hitbox
    TeamCheck=true,
    LowHP_KS=false,
    WalkSpeed=90,
...
AddToggle("Hitbox","ESP 2D THEO HITBOX","ESP_2D_Hitbox") -- NÚT ESP 2D MỚI
    ...
    for _,p in Players:GetPlayers()do
        ...
        if enableHitbox then
            ...
            if valid then
                ...
                -- [FIX BUGS] THAY ĐỔI THEO ĐIỀU KIỆN ĐỂ TRÁNH FREEZE
        ...
        if _G.Config.ESP_Name_P or _G.Config.ESP_Health_P or _G.Config.ESP_Distance_P or _G.Config.ESP_Box_P then
            ...
            -- [NEW] PHÓNG TO ESP 2D THEO KÍCH THƯỚC HITBOX
    ...
    for obj in pairs(CachedNPCs) do
        ...
        if hum and hrp and hum.Health > 0 then
            if _G.Config.Hitbox_NPC then
                ...
                -- [FIX BUGS] THAY ĐỔI THEO ĐIỀU KIỆN ĐỂ TRÁNH FREEZE CHO NPC
            ...
            if _G.Config.ESP_NPC_Name or _G.Config.ESP_NPC_Box then
                ...
                -- [NEW] PHÓNG TO ESP 2D THEO KÍCH THƯỚC HITBOX NPC
