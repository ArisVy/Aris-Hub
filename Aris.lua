...
game:GetService("StarterGui"):SetCore("SendNotification",{
    ...
    Text="Đã đền bù đủ vật liệu! Full tính năng 100%",
    Duration=8
})
...
-- Khởi tạo Part WaterWalk
local WaterPart = Instance.new("Part")
WaterPart.Name = "ArisWaterWalk"
WaterPart.Size = Vector3.new(2048, 2, 2048) -- Max size, sẽ bám theo X,Z của người chơi
WaterPart.Anchored = true
WaterPart.CanCollide = false
WaterPart.Transparency = 1
WaterPart.Material = Enum.Material.SmoothPlastic
WaterPart.Color = Color3.fromRGB(135, 206, 250) -- Màu xanh dương nhẹ
...
AddToggle("Misc","WATER WALK","WaterWalk")
...
RunService.Heartbeat:Connect(function(dt)
    ...
    -- [MỚI] Logic WaterWalk (Bám dính chân người chơi liên tục)
    if _G.Config.WaterWalk and myRoot then
        WaterPart.CanCollide = true
        WaterPart.Transparency = 0.5
        WaterPart.CFrame = CFrame.new(myRoot.Position.X, 5, myRoot.Position.Z)
    else
        WaterPart.CanCollide = false
        WaterPart.Transparency = 1
    end
